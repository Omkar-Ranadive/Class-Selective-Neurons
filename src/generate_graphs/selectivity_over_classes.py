...
parser.add_argument("--class_min", required=True, type=int) 
parser.add_argument("--class_max", required=True, type=int)
...
classes = list(range(args.class_min, args.class_max+1))
