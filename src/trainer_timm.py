"""
Adapted from https://github.com/rwightman/pytorch-image-models/blob/main/train.py
"""
...
parser.add_argument('--data_dir', metavar='DIR',
                    default=str(IMGNET_PATH), help='path to dataset')
...
def main():
    ...
    if utils.is_primary(args):
        ...
        output_dir = utils.get_outdir(args.output if args.output else DATA_PATH, exp_name)
    ...
    try:
        # Save checkpoint 0 (initialized model)
        best_metric, best_epoch = saver.save_checkpoint(0, metric=0)
