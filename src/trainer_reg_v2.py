...
from class_selectivity_v2 import forward_grad
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained:
        ...
        model = NewModel(arch=args.arch, pretrained=True)
        args.return_nodes = model.return_nodes
    else:
        print("=> creating model '{}'".format(args.arch))
        # model = models.__dict__[args.arch]()
        model = NewModel(arch=args.arch)
        args.return_nodes = model.return_nodes
