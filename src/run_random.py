"""
Perform random ablations across of the layers of ResNet50 and observe the performance 
"""
...
for layer in range(4, 8): 
    ...
    for nc in X: 
        t1, t5 = validate(val_loader=val_loader, model=model, criterion=criterion, ablate_dict=ablate_dict, num_channels=nc, class_selectivity=None) 
